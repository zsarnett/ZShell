Author:
	Zack Arnett | arnett.zackary@gmail.com | April 4
...
Contents:
	...
	parser.c
		This the the file that runs the parse and free command functions
...
References:
	The design of getting the lines from the file came from EVAN HEATON who explained how fgets is better than using fread. 
